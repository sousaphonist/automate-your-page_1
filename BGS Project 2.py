...
['How to Program', "Whether it's HTML, Python, Java, or some other programming language, a computer can only interpret instructions, known as code, in a form it can interpret. Different programming languages are better at executing different things."],
